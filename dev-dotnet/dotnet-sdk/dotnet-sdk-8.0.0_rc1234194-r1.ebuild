...
PATCHES=(
    "${FILESDIR}"/arcadebuildsh.patch
    "${FILESDIR}"/aspnetcorebuildsh.patch
    "${FILESDIR}"/cecilbuildsh.patch
    "${FILESDIR}"/commandlineapbuildsh.patch
    "${FILESDIR}"/deploymenttoolsbuildsh.patch
    "${FILESDIR}"/diagnosticsbuildsh.patch
    "${FILESDIR}"/directorybuildtargets.patch
    "${FILESDIR}"/emsdkbuildsh.patch
    "${FILESDIR}"/formatbuildsh.patch
    "${FILESDIR}"/fsharpbuildsh.patch
    "${FILESDIR}"/installerbuildsh.patch
    "${FILESDIR}"/msbuildbuildsh.patch
    "${FILESDIR}"/nugetclientbuildsh.patch
    "${FILESDIR}"/razorbuildsh.patch
    "${FILESDIR}"/roslyn-analyzersbuildsh.patch
    "${FILESDIR}"/roslynbuildsh.patch
    "${FILESDIR}"/run-buildsh.patch
    "${FILESDIR}"/runtimebuildsh.patch
    "${FILESDIR}"/sdkbuildsh.patch
    "${FILESDIR}"/sourcebuild.patch
    "${FILESDIR}"/sourcelinkbuildsh.patch
    "${FILESDIR}"/srcbuildexternalsbuildsh.patch
    "${FILESDIR}"/srcbuildexternalsDirBuildProps.patch
    "${FILESDIR}"/srcbuildrefpkgsbuildsh.patch
    "${FILESDIR}"/symreaderbuildsh.patch
    "${FILESDIR}"/templatingbuildsh.patch
    "${FILESDIR}"/test-templatesbuildsh.patch
    "${FILESDIR}"/vstestbuildsh.patch
    "${FILESDIR}"/xdtbuildsh.patch
    "${FILESDIR}"/xliff-tasksbuildsh.patch
)
